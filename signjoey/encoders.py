...
class TransformerEncoder(Encoder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv1 = nn.Conv1d(in_channels=512,out_channels = 512, kernel_size = 9, padding=4)
    ...
    # pylint: disable=arguments-differ
    def forward(
        self, embed_src: Tensor, src_length: Tensor, mask: Tensor, local_mask: Tensor
    ) -> (Tensor, Tensor):
        """
        ...
        embed_src = embed_src.permute(0, 2, 1)
        #embed()
        embed_src = self.conv1(embed_src)
        #embed()
